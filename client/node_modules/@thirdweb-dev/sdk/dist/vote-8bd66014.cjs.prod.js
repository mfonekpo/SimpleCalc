...
class Vote {
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new thirdwebCheckout.ContractMetadata(this.contractWrapper, thirdwebCheckout.VoteContractSchema, this.storage);
  ...
  async getProposalVotes(proposalId) {
    ...
    return [{
      type: thirdwebCheckout.VoteType.Against,
      label: "Against",
      count: votes.againstVotes
    }, {
      type: thirdwebCheckout.VoteType.For,
      label: "For",
      count: votes.forVotes
    }, {
      type: thirdwebCheckout.VoteType.Abstain,
      label: "Abstain",
  ...
  async balanceOfToken(tokenAddress) {
    ...
    return await thirdwebCheckout.fetchCurrencyValue(this.contractWrapper.getProvider(), tokenAddress, await erc20.balanceOf(this.contractWrapper.readContract.address));
  }
  ...
  async settings() {
    ...
    const votingTokenMetadata = await thirdwebCheckout.fetchCurrencyMetadata(this.contractWrapper.getProvider(), votingTokenAddress);
    return {
