 ...
 *
 */
class TokenDrop extends thirdwebCheckout.StandardErc20 {
  /**
  ...
  constructor(network, address, storage) {
    ...
    this.abi = abi;
    this.metadata = new thirdwebCheckout.ContractMetadata(this.contractWrapper, thirdwebCheckout.DropErc20ContractSchema, this.storage);
    this.roles = new thirdwebCheckout.ContractRoles(this.contractWrapper, TokenDrop.contractRoles);
...
defineProperty._defineProperty(TokenDrop, "contractRoles", ["admin", "transfer"]);
