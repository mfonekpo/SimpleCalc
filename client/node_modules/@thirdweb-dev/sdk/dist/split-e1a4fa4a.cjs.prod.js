...
class Split {
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new thirdwebCheckout.ContractMetadata(this.contractWrapper, thirdwebCheckout.SplitsContractSchema, this.storage);
    this.roles = new thirdwebCheckout.ContractRoles(this.contractWrapper, Split.contractRoles);
  ...
  async balanceOfToken(walletAddress, tokenAddress) {
    ...
    return await thirdwebCheckout.fetchCurrencyValue(this.contractWrapper.getProvider(), tokenAddress, value);
  }
