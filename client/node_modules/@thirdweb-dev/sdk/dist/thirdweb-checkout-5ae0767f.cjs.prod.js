...
var zod = require('zod');
var QueryParams = require('./QueryParams-d34a661c.cjs.prod.js');
...
var DropERC20_V2Abi = require('@thirdweb-dev/contracts-js/dist/abis/DropERC20_V2.json');
...
var DropERC721_V3Abi = require('@thirdweb-dev/contracts-js/dist/abis/DropERC721_V3.json');
...
var DropERC1155_V2Abi = require('@thirdweb-dev/contracts-js/dist/abis/DropERC1155_V2.json');
...
class StaticJsonRpcBatchProvider extends ethers.providers.StaticJsonRpcProvider {
  constructor(url, network) {
    ...
    super(url, network);
    defineProperty._defineProperty(this, "_timeLimitMs", void 0);
    defineProperty._defineProperty(this, "_sizeLimit", void 0);
...
function getProviderForNetwork(network) {
  ...
  switch (network) {
    case "mainnet":
    case "ethereum":
      return QueryParams.getRpcUrl("ethereum");
    case "goerli":
      return QueryParams.getRpcUrl("goerli");
    case "polygon":
    case "matic":
      return QueryParams.getRpcUrl("polygon");
    case "mumbai":
      return QueryParams.getRpcUrl("mumbai");
    case "optimism":
      return QueryParams.getRpcUrl("optimism");
    case "optimism-goerli":
      return QueryParams.getRpcUrl("optimism-goerli");
    case "arbitrum":
      return QueryParams.getRpcUrl("arbitrum");
    case "arbitrum-goerli":
      return QueryParams.getRpcUrl("arbitrum-goerli");
    case "fantom":
      return QueryParams.getRpcUrl("fantom");
    case "fantom-testnet":
      return QueryParams.getRpcUrl("fantom-testnet");
    case "avalanche":
      return QueryParams.getRpcUrl("avalanche");
    case "avalanche-testnet":
    case "avalanche-fuji":
      return QueryParams.getRpcUrl("avalanche-fuji");
    case "binance":
      return QueryParams.getRpcUrl("binance");
    case "binance-testnet":
      return QueryParams.getRpcUrl("binance-testnet");
    default:
  ...
  constructor(reason, from, to, data, network, rpcUrl, raw, functionInfo) {
    ...
    if (functionInfo) {
      ...
      if (functionInfo.value.gt(0)) {
        builtErrorMsg += withSpaces("value", `${ethers.ethers.utils.formatEther(functionInfo.value)} ${NATIVE_TOKENS[network.chainId]?.symbol}`);
      }
    }
    try {
...
class ShardedMerkleTree {
  constructor(storage, baseUri, originalEntriesUri, shardNybbles, tokenDecimals) {
    defineProperty._defineProperty(this, "shardNybbles", void 0);
    defineProperty._defineProperty(this, "shards", void 0);
    defineProperty._defineProperty(this, "trees", void 0);
    defineProperty._defineProperty(this, "storage", void 0);
    defineProperty._defineProperty(this, "baseUri", void 0);
    defineProperty._defineProperty(this, "originalEntriesUri", void 0);
    defineProperty._defineProperty(this, "tokenDecimals", void 0);
...
class Erc20ClaimableWithConditions {
  ...
  constructor(erc20, contractWrapper, storage) {
    defineProperty._defineProperty(this, "featureName", FEATURE_TOKEN_CLAIM_CONDITIONS_V2.name);
...
class Erc721Claimable {
  constructor(erc721, contractWrapper) {
    defineProperty._defineProperty(this, "featureName", FEATURE_NFT_CLAIM_CUSTOM.name);
...
class Erc721ClaimableWithConditions {
  ...
  constructor(erc721, contractWrapper, storage) {
    defineProperty._defineProperty(this, "featureName", FEATURE_NFT_CLAIM_CONDITIONS_V2.name);
    defineProperty._defineProperty(this, "conditions", void 0);
    defineProperty._defineProperty(this, "contractWrapper", void 0);
    defineProperty._defineProperty(this, "erc721", void 0);
    defineProperty._defineProperty(this, "storage", void 0);
...
class Erc721TieredDrop {
  constructor(erc721, contractWrapper, storage) {
    defineProperty._defineProperty(this, "featureName", FEATURE_NFT_TIERED_DROP.name);
    defineProperty._defineProperty(this, "contractWrapper", void 0);
    defineProperty._defineProperty(this, "erc721", void 0);
    defineProperty._defineProperty(this, "storage", void 0);
    this.erc721 = erc721;
  ...
  async mapPayloadToContractStruct(payload) {
    ...
    const data = ethers.ethers.utils.defaultAbiCoder.encode(["string[]", "address", "address", "uint256", "address", "uint256", "uint256", "address"], [payload.tierPriority, payload.to, payload.royaltyRecipient, payload.royaltyBps, payload.primarySaleRecipient, payload.quantity, normalizedPricePerToken, payload.currencyAddress]);
    return {
      uid: payload.uid,
...
class Erc721WithQuantitySignatureMintable {
  constructor(contractWrapper, storage) {
    defineProperty._defineProperty(this, "featureName", FEATURE_NFT_SIGNATURE_MINTABLE_V2.name);
    defineProperty._defineProperty(this, "contractWrapper", void 0);
    defineProperty._defineProperty(this, "storage", void 0);
    this.contractWrapper = contractWrapper;
    this.storage = storage;
...
class Erc721 {
  ...
  constructor(contractWrapper, storage, chainId) {
    ...
    defineProperty._defineProperty(this, "tieredDropable", void 0);
    defineProperty._defineProperty(this, "signatureMintable", void 0);
    defineProperty._defineProperty(this, "contractWrapper", void 0);
    defineProperty._defineProperty(this, "storage", void 0);
    defineProperty._defineProperty(this, "_chainId", void 0);
...
class ERC1155Claimable {
  constructor(contractWrapper) {
    defineProperty._defineProperty(this, "featureName", FEATURE_EDITION_CLAIM_CUSTOM.name);
    defineProperty._defineProperty(this, "contractWrapper", void 0);
    this.contractWrapper = contractWrapper;
  }
...
class Erc1155ClaimableWithConditions {
  constructor(contractWrapper, storage) {
    defineProperty._defineProperty(this, "featureName", FEATURE_EDITION_CLAIM_CONDITIONS_V2.name);
    defineProperty._defineProperty(this, "conditions", void 0);
    defineProperty._defineProperty(this, "contractWrapper", void 0);
    defineProperty._defineProperty(this, "storage", void 0);
    this.contractWrapper = contractWrapper;
...
class Erc1155LazyMintable {
  ...
  constructor(erc1155, contractWrapper, storage) {
    defineProperty._defineProperty(this, "featureName", FEATURE_EDITION_LAZY_MINTABLE_V2.name);
    defineProperty._defineProperty(this, "revealer", void 0);
    defineProperty._defineProperty(this, "claimWithConditions", void 0);
    defineProperty._defineProperty(this, "claim", void 0);
    defineProperty._defineProperty(this, "contractWrapper", void 0);
...
const EditionDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract, _network] = await Promise.all([await EditionDropInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./edition-drop-ac395492.cjs.prod.js'); }), provider.getNetwork()]);
...
const EditionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./edition-ab6cde17.cjs.prod.js'); }), provider.getNetwork()]);
...
const MarketplaceInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./marketplace-41d6c8e9.cjs.prod.js'); }), provider.getNetwork()]);
...
const MultiwrapInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./multiwrap-edc93c6b.cjs.prod.js'); }), provider.getNetwork()]);
...
const NFTCollectionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./nft-collection-00b08756.cjs.prod.js'); }), provider.getNetwork()]);
...
const NFTDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./nft-drop-7a5ac3fc.cjs.prod.js'); }), provider.getNetwork()]);
...
const PackInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./pack-064d01ba.cjs.prod.js'); }), provider.getNetwork()]);
...
const SignatureDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./signature-drop-f35fe6fa.cjs.prod.js'); }), provider.getNetwork()]);
...
const SplitInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./split-e1a4fa4a.cjs.prod.js'); }), provider.getNetwork()]);
...
const TokenDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./token-drop-cea32763.cjs.prod.js'); }), provider.getNetwork()]);
...
const TokenInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./token-35ff43c6.cjs.prod.js'); }), provider.getNetwork()]);
...
const VoteInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./vote-8bd66014.cjs.prod.js'); }), provider.getNetwork()]);
...
class SmartContract {
  ...
  constructor(network, address, abi, storage) {
    ...
    defineProperty._defineProperty(this, "abi", void 0);
    defineProperty._defineProperty(this, "metadata", void 0);
    defineProperty._defineProperty(this, "appURI", void 0);
    defineProperty._defineProperty(this, "_chainId", void 0);
    this._chainId = chainId;
    this.storage = storage;
    this.contractWrapper = contractWrapper;
...
class ContractFactory extends ContractWrapper {
  ...
  constructor(factoryAddr, network, storage, options) {
    ...
    defineProperty._defineProperty(this, "storage", void 0);
    defineProperty._defineProperty(this, "DEFAULT_VERSION_MAP", {
...
class ContractDeployer extends RPCConnectionHandler {
  ...
  async deployBuiltInContract(contractType, contractMetadata) {
    ...
    if (activeChainId === exports.ChainId.Hardhat || activeChainId === exports.ChainId.Localhost) {
      //
