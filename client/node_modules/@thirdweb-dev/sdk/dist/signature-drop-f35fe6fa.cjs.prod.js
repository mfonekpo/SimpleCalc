 ...
 * @public
 */
class SignatureDrop extends thirdwebCheckout.StandardErc721 {
  /**
   * @internal
   */
  ...
  constructor(network, address, storage) {
    ...
    this.abi = abi;
    this.metadata = new thirdwebCheckout.ContractMetadata(this.contractWrapper, thirdwebCheckout.DropErc721ContractSchema, this.storage);
    this.roles = new thirdwebCheckout.ContractRoles(this.contractWrapper, SignatureDrop.contractRoles);
    ...
    this.erc721 = new thirdwebCheckout.Erc721(this.contractWrapper, this.storage, chainId);
    this.claimConditions = new thirdwebCheckout.DropClaimConditions(this.contractWrapper, this.metadata, this.storage);
    this.signature = new thirdwebCheckout.Erc721WithQuantitySignatureMintable(this.contractWrapper, this.storage);
    this.revealer = new thirdwebCheckout.DelayedReveal(this.contractWrapper, this.storage, thirdwebCheckout.FEATURE_NFT_REVEALABLE.name, () => this.erc721.nextTokenIdToMint());
    this.signature = new thirdwebCheckout.Erc721WithQuantitySignatureMintable(this.contractWrapper, this.storage);
...
defineProperty._defineProperty(SignatureDrop, "contractRoles", ["admin", "minter", "transfer"]);
