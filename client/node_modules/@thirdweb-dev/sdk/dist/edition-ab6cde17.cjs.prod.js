 ...
 * @public
 */
class Edition extends thirdwebCheckout.StandardErc1155 {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
    ...
    this.abi = abi;
    this.metadata = new thirdwebCheckout.ContractMetadata(this.contractWrapper, thirdwebCheckout.TokenErc1155ContractSchema, this.storage);
    this.roles = new thirdwebCheckout.ContractRoles(this.contractWrapper, Edition.contractRoles);
    ...
    this.signature = new thirdwebCheckout.Erc1155SignatureMintable(this.contractWrapper, this.storage, this.roles);
...
defineProperty._defineProperty(Edition, "contractRoles", ["admin", "minter", "transfer"]);
