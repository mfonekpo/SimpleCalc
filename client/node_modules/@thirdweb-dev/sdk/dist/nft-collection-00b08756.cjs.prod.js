 ...
 * @public
 */
class NFTCollection extends thirdwebCheckout.StandardErc721 {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
    ...
    this.abi = abi;
    this.metadata = new thirdwebCheckout.ContractMetadata(this.contractWrapper, thirdwebCheckout.TokenErc721ContractSchema, this.storage);
    this.roles = new thirdwebCheckout.ContractRoles(this.contractWrapper, NFTCollection.contractRoles);
...
defineProperty._defineProperty(NFTCollection, "contractRoles", ["admin", "minter", "transfer"]);
