...
// node_modules/@thirdweb-dev/sdk/dist/vote-5ac9a9af.esm.js
...
var Vote = class {
  ...
  async canExecute(proposalId) {
    ...
    const descriptionHash = ethers_exports.utils.id(proposal.description);
    try {
  ...
  async balance() {
    ...
    return {
      ...
      decimals: 18,
      value: balance,
      displayValue: ethers_exports.utils.formatUnits(balance, 18)
    };
  }
...
//# sourceMappingURL=vote-5ac9a9af.esm-JWO77YSX.js.map
